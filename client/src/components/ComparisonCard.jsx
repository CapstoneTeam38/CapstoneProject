  ...
  return (
    <div className="glass-panel p-6 border-white/5 h-[400px] flex flex-col">
      <div className="flex items-center justify-between mb-6">
        <div>
          <h3 className="text-sm font-bold text-white uppercase tracking-wider">Average Transaction Value</h3>
          <p className="text-[10px] text-slate-500 uppercase tracking-widest mt-1">Legitimate vs. Fraudulent Behavioral Comparison</p>
        </div>
      </div>
      ...
      <div className="mt-4 grid grid-cols-2 gap-4">
        {chartData.map((item, i) => (
          <div key={i} className="bg-white/[0.02] border border-white/5 rounded-lg p-3 text-center">
             <div className="text-[9px] font-bold text-slate-500 uppercase tracking-widest mb-1">{item.name} Max</div>
